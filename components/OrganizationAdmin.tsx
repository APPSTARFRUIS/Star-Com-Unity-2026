...
const OrganizationAdmin: React.FC<Props> = ({
  ...
  const [contact, setContact] = useState({ name: '', email: '', phone: '', jobTitle: '', jobDescription: '', personalNote: '', about: '' });
